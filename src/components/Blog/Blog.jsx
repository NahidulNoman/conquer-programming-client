...
const Blog = () => {
  return (
    <div className="container mt-5">
      <h2 className="text-center m-5 fw-bold text-success">
      ...
      <div className="shadow-lg p-3 rounded mb-5 bg-light">
        ...
        <p className="fw-semibold opacity-75">
          ...
          resources. Most of the time, a script running in the user's browser
          would only ever need to access resources on the same origin (think
          about API calls to the same backend that served the JavaScript code in
          the first place). So the fact that JavaScript can't normally access
          resources on other origins is a good thing for security. In this
          context, "other origins" means the URL being accessed differs from the
          location that the JavaScript is running from, by having: <br />
      ...
      <div className="shadow-lg p-3 rounded mb-5 bg-light">
        ...
        <p className="fw-semibold opacity-75">
          Firebase helps to develop high-quality apps, grow user base, and earn
          more money. Each feature works independently, and they work even
          better together. Firebase provides detailed documentation and
          cross-platform SDKs to help you build and ship apps on Android, iOS,
          the web, C++, and Unity. <br />
          ...
          accounts (more options can be found here).
        </p>
      </div>
      <div className="shadow-lg p-3 rounded mb-5 bg-light">
      ...
      <div className="shadow-lg p-3 rounded mb-5 bg-light">
        ...
        <p className="fw-semibold opacity-75">
          Node.js is a JavaScript runtime for building server-side or desktop
          applications. Node.js is an open source server environment, Node.js is
          free, it runs on various platforms (Windows, Linux, Unix, Mac OS X,
          etc.) and it uses JavaScript on the server. As an asynchronous
          event-driven JavaScript runtime, Node.js is designed to build scalable
      ...
      <div className="shadow-lg p-3 rounded mb-5 bg-light">
        ...
        <p className="fw-semibold opacity-75">
          ...
          data-intensive. Node.js is an event loop single-threaded language.
          Thread is a sequence of instructions that the server needs to perform.
          It runs parallel on the server to provide the information to multiple
          clients. Node.js accepts the request from the clients and sends the
